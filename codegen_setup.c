...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Rival Schools: Evolution Disc",
    .project_root_env = "RIVAL_SCHOOLS_EVOLUTION_DISC_PROJECT_ROOT",
    .build_dir_env = "RIVAL_SCHOOLS_EVOLUTION_DISC_BUILD_DIR",
    .force_setup_env = "RIVAL_SCHOOLS_EVOLUTION_DISC_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_007.71_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Rival_Schools_Evolution_Disc",
    .prepare_note =
