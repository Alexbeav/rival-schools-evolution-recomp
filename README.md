...
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/Alexbeav/rival-schools-evolution-recomp/total)](https://github.com/Alexbeav/rival-schools-evolution-recomp/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/Alexbeav/rival-schools-evolution-recomp/latest/total)](https://github.com/Alexbeav/rival-schools-evolution-recomp/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/Alexbeav/rival-schools-evolution-recomp)](https://github.com/Alexbeav/rival-schools-evolution-recomp/releases/latest)
<!-- /retcomm-readme-metrics -->

Static recompilation of **Rival Schools: Evolution Disc** built on
[psxrecomp](https://github.com/mstan/psxrecomp) and
[recomp-ui](https://github.com/RetroPortingToolKit/recomp-ui).

This is an owned-input setup kit. You supply your own SLUS-00771 disc image
...
|---|---|
| Region | USA |
| Disc serial | SLUS-00771 |
| Discs | 1 |
| Supported dump | Redump `Rival Schools - United by Fate (USA) (Disc 2) (Evolution Disc).cue` as CUE/BIN or CHD |
...
- Save carry-over between the two discs: see *Two discs, two kits* above.
